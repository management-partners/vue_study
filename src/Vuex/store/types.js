...
// getters
export const DOUBLE_COUNTER = 'counter/DOUBLE_COUNT'
export const CLICK_COUNTER = 'counter/CLICK_COUNTER'
export const VALUE = 'share/VALUE'
...
export const MUTATE_UPDATE_VALUE = 'share/MUTATE_UPDATE_VALUE'
...
export const UPDATE_VALUE = 'share/UPDATE_VALUE'
